...
import 'package:bloc_input_valueobject/src/domain/entities/token.dart'
    as e_token;
import 'package:bloc_input_valueobject/src/presentaion/core/styles/app_styles.dart';
        ...
        switch (state) {
          case final SettingsStateUpdate update:
            if (update.saveRequested) {
              context
                  .read<SettingsBloc>()
                  .add(const SettingsEventSaveHandled());

              ScaffoldMessenger.of(context).clearSnackBars();
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    update.saveFailure.fold(
                      () => 'Save success!',
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) => interval.value.fold(
                            (l) => switch (l) {
                              e_interval.IntervalFailureEmpty() => 'empty',
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        '0x'
                                        '${e.toRadixString(16).toUpperCase()}',
                                      ),
                                    ],
                                  ),
                                ),
